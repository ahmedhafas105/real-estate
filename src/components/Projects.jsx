...
const Projects = () => {
  ...
  return (
    ...
    >
      ...
      <p className="text-center text-gray-500 mb-8 max-w-80 mx-auto">Crafting Spaces, Building Legacies-Explore Out Porfolio</p>
                    ...
                    <div className="absolute left-0 right-0 bottom-5 flex justify-center">
                        <div className="inline-block bg-white w-3/4 px-4 py-2 shadow-md">
                            ...
                            <p className="text-gray-500 text-sm">
                                {project.price} <span className="px-0.3">|</span> {project.location}
                            </p>
                        </div>
                    </div>
                </div>
